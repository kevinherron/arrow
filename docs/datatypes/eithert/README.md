...
lifted
//(kotlin.Int) -> kategory.effects.ObservableKW<kategory.Either<Line_2.BizError, kategory.Option<kategory.effects.ObservableKW<kategory.Either<Line_2.BizError, kotlin.String>>>>>
```
...
eitherTVal
//EitherT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@f24ac46))
```
...
```kotlin
eitherTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@f24ac46)
```
