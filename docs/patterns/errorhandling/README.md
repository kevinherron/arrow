...
//kategory.OptionMonadErrorInstanceImplicits$instance$1@1cc41a5d
```

```kotlin
monadError<TryHK, Throwable>()
//kategory.TryMonadErrorInstanceImplicits$instance$1@4602e5f5
```

```kotlin
monadError<EitherKindPartial<NukeException>, NukeException>()
//kategory.EitherMonadErrorInstanceImplicits$instance$1@5b4c436c
```
